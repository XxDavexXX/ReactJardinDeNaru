            ...
            <div className="contenedor_foto_preguntas">
                <div className="contentPreguntasRespuestas">
                    <div className="accordion" id="accordionExample">
                        ...
                        <div className="accordion-item">
                            <h2 className="accordion-header">
                                <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThrerten" aria-expanded="false" aria-controls="collapseThrerten">
