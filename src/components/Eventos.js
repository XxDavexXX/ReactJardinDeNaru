        ...
        <div className="content_nosotros">
            ...
            <header id="home" className="header">
                ...
                <div className="header-content">
                    ...
                    <h6>Eventos</h6>
                    <button className="btn btn-outline-light">Comprar Aquí</button>
                </div>
            </header>
                ...
                <div className="container">
                    <div className="row justify-content-between align-items-center">
                        ...
                        <div className="col-md-5">
                            ...
                            <button className="btn btn-outline-success btn-sm">Aprende Más</button>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="container">
                    <div className="row justify-content-between align-items-center">
                        <div className="col-md-5">
                            ...
                            <button className="btn btn-outline-success btn-sm">Más Información</button>
                        </div>
                        <div className="col-md-6">
                            <div className="img-wrapper">
                ...
                <div className="container">
                    <div className="row justify-content-between align-items-center">
                        ...
                        <div className="col-md-5">
                            ...
                            <button className="btn btn-outline-success btn-sm">Conoce Más</button>
                        </div>
                    </div>
                </div>
            </section>
