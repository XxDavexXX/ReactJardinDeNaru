...
function Home() {
    return (
      <div>
        ...
        <div class="content_content_img_intro">
          <div class="content_img_intro">
            ...
            <div class="segundo_content">
              <div class="segundo_content_title">Explora el mundo botánico en El Jardín de Naru</div>
              <div class="segundo_content_text">¿Te apasionan las plantas? ¿Buscas algo más que un simple adorno? En El Jardín de Naru, te invitamos a explorar nuestro extenso catálogo de plantas externas, internas, decorativas y medicinales. Cada planta cuenta una historia, ¿cuál será la tuya?</div>
              <div class="segundo_content_text">En El Jardín de Naru, hemos creado un espacio donde los amantes de las plantas encuentran su refugio. Sumérgete en un mundo de colores, fragancias y beneficios naturales. Navega por nuestras secciones y descubre cómo la naturaleza puede transformar tu entorno y mejorar tu bienestar.</div>
              <button class="button">
        ...
        <div class="content_accesorios_title">
          <div class="content_accesorios_title_div">
            <div class="content_accesorios_title_div_dos">TRAE LA NATURALEZA DEVUELTA A TU HOGAR</div>
          </div>
        </div>

        <div class="content_accesorios">

          <div class="content_accesorios_uno">
            <img class="content_accesorios_uno_one_img" src={accesorio_uno}></img>
            <div class="content_accesorios_uno_one_div">
              <div class="content_accesorios_uno_one_div_div_one">Colección</div>
              <div class="content_accesorios_uno_one_div_div_dos">PLANTAS</div>
            </div>
          </div>

          <div class="content_accesorios_uno">
            <img class="content_accesorios_uno_one_img" src={accsesorio_dos}></img>
            <div class="content_accesorios_uno_one_div">
              <div class="content_accesorios_uno_one_div_div_one">Colección</div>
              <div class="content_accesorios_uno_one_div_div_dos">MACETAS & PARANTES</div>
            </div>
          </div>

          <div class="content_accesorios_uno">
            <img class="content_accesorios_uno_one_img" src={accsesorio_tres}></img>
            <div class="content_accesorios_uno_one_div">
              <div class="content_accesorios_uno_one_div_div_one">Colección</div>
              <div class="content_accesorios_uno_one_div_div_dos">ACCESORIOS</div>
            </div>
          </div>
          ...
          <div className="hero">
            <div className="textos-hero">
              ...
              <div className="formulario">
                <form action="">
                  <div class="titulo_form">Para algún pedido especial o consulta</div>
                  <div class="contenedor_filas_form">
                    <div class="contenedor_filas_form_uno">
                      <label htmlFor="nombre">Nombre *</label>
                      <input type="text" id="nombre" placeholder="Por ejemplo, Dave" name="nombre" required />
                    </div>
                    <div class="contenedor_filas_form_uno">
                      <label htmlFor="apellido">Apellido</label>
                      <input type="text" id="apellido" placeholder="Por ejemplo, Santivanez" name="apellido" />
                    </div>
                  </div>
                  <div class="contenedor_filas_form">
                    <div class="contenedor_filas_form_uno">
                      <label htmlFor="email">Email *</label>
                      <input type="email" id="email" placeholder="Por ejemplo, mail@ejemplo.com" name="email" required />
                    </div>
                    <div class="contenedor_filas_form_uno">
                      <label htmlFor="telefono">Teléfono</label>
                      <input type="tel" id="telefono" placeholder="Por ejemplo, 903 - 010 - 882" name="telefono" />
                    </div>
                  </div>
                  <div class="contenedor_filas_form">
                    <div class="contenedor_filas_form_textarea">
                      <label htmlFor="mensaje">Mensaje *</label>
                      <textarea class="message_input" placeholder="Escribe tu mensaje aquí..." id="mensaje" rows="5" cols="30" name="mensaje" required></textarea>
                    </div>
                  </div>

                  {/*  */}
                  <button class="btn_form_send">
                    <span class="spam_form">Enviar</span>
                    <div class="top"></div>
                    <div class="left"></div>
